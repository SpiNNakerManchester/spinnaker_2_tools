...
open(FH, "<", "$ENV{ICPRO_DIR}/units/quadpe/source/rtl/verilog/quadpe_regfile.v") or die "Cant't open file: $!";
...
printf("\n#include <stdint.h>\n\n");
printf("typedef struct quadpe_config_str {\n");
