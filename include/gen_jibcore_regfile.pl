...
open(FH, "<", "$ENV{ICPRO_DIR}/units/jib1_core/source/rtl/verilog/jib1_core_regfile.v") or die "Cant't open file: $!";
...
printf("\n#include <stdint.h>\n\n");
printf("typedef struct jibcore_config_str {\n");
